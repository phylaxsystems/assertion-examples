...
contract TestERC4626AssetsShares is CredibleTest, Test {
    ...
    function test_assertionFailsWithSpecialCase42() public {
        address protocolAddress = address(protocol);
        string memory label = "Special case 42 breaks asset backing";
        ...
        cl.validate(label, protocolAddress, 0, abi.encodePacked(protocol.setTotalSupply.selector, abi.encode(42 ether)));
    }
}
